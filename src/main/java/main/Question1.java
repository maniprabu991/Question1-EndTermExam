...
class ECE extends Courses { //extend the parent class here 
	...
	public String displayCourseDetails(String dept) {
		...
		this.e=dept;
		String commonSubjects = super.displayCourseDetails(e);//call the parent function after using inheritence
...
class Mechanical extends Courses { //extend the parent class here 
	...
	public String displayCourseDetails(String dept) {
		// write or edit your code here 
		this.m=dept;
		String commonSubjects = super.displayCourseDetails(m);//call the parent function after using inheritence
...
class CSE extends Courses  { //extend the parent class here 
	...
	public String displayCourseDetails(String dept) {
		...
		// write or edit your code here 
		this.c=dept;
		String commonSubjects = super.displayCourseDetails(c);//call the parent function after using inheritence
